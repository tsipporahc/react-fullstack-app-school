...
exports.authenticateUser = async (req, res, next) => {
  ...
  if (credentials) {
    ...
    if (user) {
      const authenticated = bcrypt.compareSync(credentials.pass, user.password); // credentials.pass is password secret. compareSync() method hashes the user's password before comparing it to the stored hashed value).
